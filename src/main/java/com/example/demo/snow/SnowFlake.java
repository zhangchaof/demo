...
public class SnowFlake {
    ...
    public static class Factory {
        ...
        public SnowFlake create(long idcId, long machineId) {
            return new SnowFlake(this.idcBitNum, this.machineBitNum, idcId, machineId);
        }
    }
    ...
    private SnowFlake(int idcBitNum, int machineBitNum, long idcId, long machineId) {
...
//                throw new IllegalStateException("sequence over flow");
    ...
    public static void main(String[] args) {
        System.out.println("SnowFlake.REMAIN_BIT_NUM = " + SnowFlake.REMAIN_BIT_NUM);
    }
}
